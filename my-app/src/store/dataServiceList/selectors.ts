...
export const useError = () => useSelector((state: RootState) => (state.dataList.error))

export const useSuccessAddToDraft = () => useSelector((state: RootState) => (state.dataList.successAddToDraft))